...
@section('content')
<div class="mb-7 flex flex-col gap-5 md:flex-row
    ...
    <div>
        ...
        <p class="mt-2 text-sm text-slate-500">
            Find and download lecture notes shared by students.
        </p>
    </div>
    ...
    <a
        ...
        class="inline-flex min-h-11 items-center justify-center gap-2
               rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-bold
               text-white shadow-sm shadow-blue-200 transition
...
<form
    ...
    data-live-search-target="notes"
    class="mb-7 rounded-2xl border border-slate-200
           bg-white p-4 shadow-sm sm:p-5"
>
    <div class="grid gap-4
                lg:grid-cols-[minmax(240px,1.7fr)_repeat(4,minmax(140px,1fr))]">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input
                    ...
                    autocomplete="off"
                    placeholder="Start typing a note title or course..."
            ...
            <p
                ...
                class="mt-1 min-h-4 text-xs font-medium text-blue-600"
            ></p>
        </div>
    ...
    <div class="mt-4 flex flex-wrap items-center
        ...
        <button
            ...
            class="inline-flex min-h-10 items-center
                   justify-center rounded-lg bg-slate-900
...
{{-- Live Results Area --}}
<div
    data-live-search-results="notes"
    aria-live="polite"
...
>
    @if ($notes->isEmpty())
        ...
        <div class="rounded-2xl border border-dashed
            ...
            <span class="mx-auto grid size-14 place-items-center
            ...
            <p class="mx-auto mt-2 max-w-md
                ...
                @if (
                    ...
                    No note matched your search.
                    Try another letter, title, or filter.
                @else
                    Be the first student to share a note.
                @endif
            </p>

            <a
                href="{{ route('notes.create') }}"
                class="mt-5 inline-flex min-h-10 items-center
        ...
        <div class="grid gap-5 md:grid-cols-2">
            @foreach ($notes as $note)
                ...
                @php
                    ...
                    $isImage = in_array(
                        strtolower($note->format),
                        ['jpg', 'jpeg', 'png', 'webp']
                    );
                @endphp

                <article class="flex min-h-56 flex-col
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <span class="grid size-14 shrink-0
                    ...
                    <div class="mt-auto flex flex-col gap-4
                        ...
                        <div class="flex gap-2">
                            <a
                                ...
                                target="_blank"
                                rel="noopener"
                                class="inline-flex min-h-10 flex-1
                                       items-center justify-center
                                       rounded-lg border border-blue-200
                                       px-4 py-2 text-sm font-bold
                                       text-blue-700 transition
                                       hover:bg-blue-50 sm:flex-none"
                            >
                                Preview
                            </a>
