...
class ProjectRecruitmentTest extends TestCase
{
    ...
    public function test_creator_can_approve_and_reject_applicant_requests(): void
    {
        ...
        $rejResponse = $this->actingAs($creator)->delete("/projects/recruitment/{$project->id}/requests/{$req2->id}/reject");
    ...
    public function test_non_creator_cannot_approve_or_reject_requests(): void
    {
        ...
        $hackerReject = $this->actingAs($hacker)->delete("/projects/recruitment/{$project->id}/requests/{$request->id}/reject");
