...
<div class="container-fluid px-lg-4">
    <!-- Back Link -->
    <div class="mb-3">
        <a href="{{ route('projects.show', $project) }}" class="text-decoration-none text-secondary small d-inline-flex align-items-center gap-1">
    ...
    <form method="POST" action="{{ route('projects.update_recruitment', $project) }}">
        @csrf
        @method('PUT')
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-5">
                ...
                <div class="d-flex align-items-center justify-content-end gap-2">
                    <a href="{{ route('projects.show', $project) }}" class="btn btn-light border px-3">
                        Cancel
                    </a>
