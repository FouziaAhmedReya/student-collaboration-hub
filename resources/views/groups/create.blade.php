        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-5">
                <div class="hub-card p-4 shadow-sm">
                    ...
                    <div class="mb-3">
                        <label class="form-label small fw-semibold text-muted">Click or drag marker on the map to set meeting venue</label>
                        <div id="groupCreateMap" class="rounded-3 border" style="height: 220px; width: 100%;"></div>
                    </div>
