...
<div class="grid gap-7
            lg:grid-cols-[minmax(0,1.2fr)_minmax(340px,.8fr)]">
    ...
    <div class="space-y-5">
        ...
        <div>
            ...
            <select
                ...
                name="department"
                required
                class="min-h-11 w-full rounded-xl border bg-white
        ...
        <div class="grid gap-5 sm:grid-cols-2">
            ...
            <div>
                ...
                <input
                    ...
                    maxlength="120"
                    required
                    placeholder="Example: CSE421 Computer Networks"
    ...
    <div>
        <label class="mb-2 block text-sm font-bold text-slate-800">
            {{ $editing ? 'Replace File' : 'Note File' }}
        ...
        <label
            ...
            data-file-drop
            data-dragging="false"
            class="group flex min-h-80 cursor-pointer
                   flex-col items-center justify-center
                   rounded-2xl border-2 border-dashed
                   border-slate-300 bg-slate-50 px-6 py-10
                   text-center transition hover:border-blue-400
                   hover:bg-blue-50/50
                   data-[dragging=true]:border-blue-500
                   data-[dragging=true]:bg-blue-50"
        >
            <span class="grid size-16 place-items-center
                ...
                >
                    <path
                        d="M7 18H5.5A3.5 3.5 0 0 1 5 11a7 7 0 0 1 13.5-1.5A4.5 4.5 0 0 1 18 18h-1"
                        stroke-linecap="round"
                    />

                    <path
                        d="M12 20V10m0 0-3.5 3.5M12 10l3.5 3.5"
                        stroke-linecap="round"
            ...
            <span class="mt-5 text-base font-bold text-slate-900">
                Drag and drop your file here
            </span>

            <span class="my-2 text-xs font-medium uppercase
                         tracking-wide text-slate-400">
                or
            </span>

            <span class="rounded-lg bg-blue-600 px-5 py-2.5
            ...
            <span
                data-file-name
                class="mt-4 max-w-full break-all
            ...
            <span class="mt-2 text-xs leading-5 text-slate-500">
                PDF, DOC, DOCX, PPT, PPTX, JPG, PNG or WEBP
                · Maximum 10 MB
            </span>
        ...
        @if ($editing)
            <p class="mt-3 text-xs leading-5 text-slate-500">
                Leave the file field empty to keep the existing
                Cloudinary file.
            </p>
        @endif
    </div>
...
<div class="mt-8 flex flex-col-reverse gap-3
    ...
    <button
        type="submit"
        class="inline-flex min-h-11 items-center justify-center
               gap-2 rounded-xl bg-blue-600 px-6 py-2.5
               text-sm font-bold text-white shadow-sm
