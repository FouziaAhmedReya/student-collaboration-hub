    ...
    <div class="flex flex-wrap gap-3">
        <a
            ...
            class="inline-flex min-h-11 items-center justify-center
                   ...
                   px-5 text-sm font-bold text-slate-700
...
<form
    ...
    data-live-search-target="marketplace"
    ...
    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-6">
        ...
        <div class="lg:col-span-2">
            ...
            <input
                ...
                autocomplete="off"
                placeholder="Start typing a title, author, or course..."
...
<div
    data-live-search-results="marketplace"
    aria-live="polite"
...
>
    @if ($books->isEmpty())
        ...
        <div class="rounded-2xl border border-dashed
            ...
            <p class="mt-2 text-sm text-slate-500">
                ...
                Try another letter, title, author, or course.
            </p>
    ...
    @else
        ...
        @if ($books->hasPages())
            <div
                data-live-pagination="marketplace"
                class="mt-8"
            >
